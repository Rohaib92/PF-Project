...
int screen_x = 1136;
int screen_y = 896;
void display_level1(RenderWindow& window, char**lvl, Texture& bgTex,Sprite& bgSprite,Texture& blockTexture,Sprite& blockSprite, const int height, const int width, const int cell_size);
...
int main()
{
	...
	while (window.isOpen())
	{
		...
		display_level1(window, lvl, bgTex, bgSprite, blockTexture, blockSprite, height, width, cell_size);
